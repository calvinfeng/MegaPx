...
Photo.create!(user_id: 2, url: "https://res.cloudinary.com/megapx/image/upload/v1462145894/Seeds/5.jpg",
...
Photo.create!(user_id: 2, url: "https://res.cloudinary.com/megapx/image/upload/v1462145913/Seeds/11.jpg",
lat: 37.801744, lng: -122.478590, width: 688, height: 1000)
Photo.create!(user_id: 2, url: "https://res.cloudinary.com/megapx/image/upload/v1462145928/Seeds/12.jpg",
lat: 37.777179, lng: -122.432732, width: 2000, height: 721)
Photo.create!(user_id: 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462145931/Seeds/13.jpg",
lat: 37.786958, lng: -122.438250, width: 2000, height: 1589)
Photo.create!(user_id: 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462145923/Seeds/14.jpg",
lat: 37.802151, lng: -122.396879, width: 2000, height: 1333)
Photo.create!(user_id: 2, url: "https://res.cloudinary.com/megapx/image/upload/v1462145936/Seeds/15.jpg",
lat: 37.821137, lng: -122.500563, width: 2000, height: 1370)
Photo.create!(user_id: 5, url: "https://res.cloudinary.com/megapx/image/upload/v1462145862/Seeds/16.jpg",
lat: 37.794210, lng: -122.404325, width: 2000, height: 1359)
Photo.create!(user_id: 1, title: "Snake Trails", url: "https://res.cloudinary.com/megapx/image/upload/v1462145865/Seeds/17.jpg",
...
Photo.create!(user_id: 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462145860/Seeds/19.jpg",
lat: 37.790485, lng: -122.390184, width: 2000, height: 1333)
Photo.create!(user_id: 5, url: "https://res.cloudinary.com/megapx/image/upload/v1462145863/Seeds/20.jpg",
lat: 37.795640, lng: -122.481508, width: 2000, height: 1335)
Photo.create!(user_id: 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462145876/Seeds/21.jpg",
...
Photo.create!(user_id: 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462145894/Seeds/23.jpg",
...
Photo.create!(user_id: 1, url:"https://res.cloudinary.com/megapx/image/upload/v1462145907/Seeds/27.jpg",
lat: 37.778648, lng: -122.387635, width: 2000, height: 1265)
Photo.create!(user_id: 1, url:"https://res.cloudinary.com/megapx/image/upload/v1462145907/Seeds/28.jpg",
...
Photo.create!(user_id: 1, title: "Construction", url: "https://res.cloudinary.com/megapx/image/upload/v1462421535/Seeds/hk07.jpg",
width: 2000, height: 1125, lat: 22.316845, lng: 114.171896)

## New York
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "Brooklyn", url: "https://res.cloudinary.com/megapx/image/upload/v1462421544/Seeds/ny01.jpg",
width: 2000, height: 750, lat: 40.700144, lng: -74.000344)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "Night", url: "https://res.cloudinary.com/megapx/image/upload/v1462421562/Seeds/ny02.jpg",
width: 2000, height: 1333, lat: 40.708472, lng: -74.007983)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421553/Seeds/ny03.jpg",
width: 2000, height: 932, lat: 40.708538, lng: -74.033475)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421553/Seeds/ny04.jpg",
width: 1700, height: 1135, lat: 40.702421, lng: -73.996911)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421550/Seeds/ny05.jpg",
width: 2000, height: 1333, lat: 40.693441, lng: -74.003091)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "Empire State", url: "https://res.cloudinary.com/megapx/image/upload/v1462421564/Seeds/ny06.jpg",
width: 2000, height: 1263, lat: 40.712784, lng: -74.005941)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421553/Seeds/ny07.jpg",
width: 2000, height: 1202, lat: 40.714700, lng: -73.995066)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421568/Seeds/ny08.jpg",
width: 2000, height: 1333, lat: 40.733434, lng: -73.991976)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "My Liberty Lady", url: "https://res.cloudinary.com/megapx/image/upload/v1462421558/Seeds/ny09.jpg",
width: 2000, height: 807, lat: 40.687533, lng: -74.052690)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421578/Seeds/ny10.jpg",
width: 2000, height: 1333, lat: 40.706001, lng: -74.008801)

## Grand Canyon
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "Thunderstorm", url: "https://res.cloudinary.com/megapx/image/upload/v1462421459/Seeds/gc01.jpg",
width: 2000, height: 1218, lat: 36.037284, lng: -112.146378)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421460/Seeds/gc02.jpg",
width: 2000, height: 1253, lat: 36.059490, lng: -112.267227)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421460/Seeds/gc03.jpg",
width: 2000, height: 1334, lat: 36.073366, lng: -111.805115)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421462/Seeds/gc04.jpg",
width: 2000, height: 1362, lat: 36.026577, lng: -111.836700)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421465/Seeds/gc05.jpg",
width: 1000, height: 1000, lat: 36.175262, lng: -111.792755)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421468/Seeds/gc06.jpg",
width: 2000, height: 1352, lat: 36.192997, lng: -111.807861)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "Explorer", url: "https://res.cloudinary.com/megapx/image/upload/v1462421467/Seeds/gc07.jpg",
width: 2000, height: 1481, lat: 36.144217, lng: -112.294006)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "Light Up The Sky", url: "https://res.cloudinary.com/megapx/image/upload/v1462421469/Seeds/gc08.jpg",
width: 2000, height: 1335, lat: 36.113159, lng: -112.365417)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, title: "Horseshoe Bend", url: "https://res.cloudinary.com/megapx/image/upload/v1462421470/Seeds/gc09.jpg",
width: 2000, height: 1001, lat: 36.188564,lng: -111.803741)

## London
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421582/Seeds/uk01.jpg",
width: 1800, height: 1200, lat: 51.497410, lng: -0.176281)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421567/Seeds/uk02.jpg",
width: 2000, height: 1333, lat: 51.497410, lng: -0.176281)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421570/Seeds/uk03.jpg",
width: 2000, height: 1331, lat: 51.506219, lng: -0.075091)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421582/Seeds/uk04.jpg",
width: 1920, height: 1440, lat: 51.501023, lng: -0.119175)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421581/Seeds/uk05.jpg",
width: 2000, height: 1265, lat: 51.504409, lng: -0.076149)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421578/Seeds/uk06.jpg",
width: 2000, height: 1286, lat: 51.509455, lng: -0.104465)
Photo.create!(user_id: rand(numOfUsers).to_i + 1, url: "https://res.cloudinary.com/megapx/image/upload/v1462421583/Seeds/uk07.jpg",
