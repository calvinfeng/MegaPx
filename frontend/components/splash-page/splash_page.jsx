...
var SplashPage = React.createClass({
  ...
  clickHandle: function() {
    $('html,body').animate({
      scrollTop: $(".introduction").offset().top},'slow');
    },
          ...
          <div className="bottom-banner">
            <div className="left-box">
              ...
              <div className="text-box">
                ...
                <a className="button" onClick={this.clickHandle}>Learn more</a>
            ...
            <div className="right-box">
              ...
              <div className="text-box">
                ...
                <a className="button" onClick={this.clickHandle}>Start browsing</a>
              </div>
            </div>
          </div>
